...
public class CrossFilter implements Filter {
	...
	public void doFilter(ServletRequest req,ServletResponse res,FilterChain chain)throws IOException,ServletException{
		...
		try {
			...
			else if(url.contains("/loan/personal-loan/apply-loan")||url.contains("/loan/personal-loan/loan-status")||url.contains("/loan/personal-loan/loan-details")||url.contains("/loan/personal-loan/calculate-emi") ||url.contains("/loan/personal-loan/user/login")||url.contains("/admin/register")||url.contains("/admin/login")||url.contains("/import-excel")||url.contains("/stripe")||url.contains("/loan/mail")) {
				chain.doFilter(req, res);
			}
				else {
